...
def cleanup_old_tasks():
    ...
    try:
        cutoff_time = datetime.datetime.now(datetime.timezone.utc).timestamp() - (24 * 60 * 60)  # 24 hours ago
        stuck_cutoff = datetime.datetime.now(datetime.timezone.utc).timestamp() - (2 * 60 * 60)  # 2 hours ago
