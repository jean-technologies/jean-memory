...
main() {
    ...
    echo ""
    echo "🚀 Next steps:"
    echo "   1. Run 'make dev-api' in one terminal to start the API server"
    echo "   2. Run 'make dev-ui' in another terminal to start the frontend"
    ...
    echo "   make dev-api     - Start API server (run in one terminal)"
    echo "   make dev-ui      - Start frontend (run in another terminal)"
