...
const availableApps: AvailableApp[] = [
  ...
  { id: 'vscode', name: 'VS Code', description: 'Code editing. Redefined.', priority: 9, category: 'Development', trustScore: 98 },
  ...
  { id: 'notion', name: 'Notion', description: 'Connected workspace for notes & projects', priority: 5, category: 'Productivity', trustScore: 92, isComingSoon: true },
