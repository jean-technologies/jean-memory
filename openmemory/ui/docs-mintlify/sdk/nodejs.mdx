...
**Note for Testing:** The Node.js SDK v1.2.10+ includes auto test user functionality that creates isolated test users for each API key, allowing you to test core functionality without implementing full authentication during development.
