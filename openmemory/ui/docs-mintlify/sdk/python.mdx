...
# For example:
# final_prompt = f"Context: {context}\n\nUser says: What were we just talking about?"
...
For quick testing or simple applications, the SDK also provides an all-in-one `send_message` method that handles both getting context and calling an LLM to get a final response.
