...
The React SDK uses a robust, backend-driven OAuth system that ensures secure authentication and consistent user identity across all applications. The SDK supports two authentication modes depending on your API key:
