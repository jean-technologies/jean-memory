...
<AccordionGroup>
  <Accordion title="Flow 1: The Proactive Briefing">
    ...
    graph TD;
        ...
        classDef trigger fill:#FFC300,stroke:#333,stroke-width:2px;
        classDef process fill:#DAF7A6,stroke:#333,stroke-width:2px;
        classDef output fill:#ADD8E6,stroke:#333,stroke-width:2px;
  ...
  <Accordion title="Flow 2: The Deep Dive Researcher">
    ...
    graph TD;
        ...
        classDef trigger fill:#FF5733,stroke:#333,stroke-width:2px;
        classDef process fill:#C70039,stroke:#FFF,stroke-width:2px,color:#FFF;
        classDef loop fill:#F9E79F,stroke:#333,stroke-width:1px;
        classDef output fill:#ADD8E6,stroke:#333,stroke-width:2px;
  ...
  <Accordion title="Flow 3: The Just-in-Time Learner">
    ...
    graph TD;
        ...
        classDef io fill:#ADD8E6,stroke:#333,stroke-width:2px;
        classDef decision fill:#FFC300,stroke:#333,stroke-width:2px;
        classDef process fill:#DAF7A6,stroke:#333,stroke-width:2px;
