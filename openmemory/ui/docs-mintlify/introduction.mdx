---
title: Introduction
description: "Jean Memory gives your AI application an intelligent memory layer in 5 lines of code."
---

import { SignInWithJean } from '@jeanmemory/react';
import CopyToClipboard from './snippets/CopyToClipboard.tsx';
