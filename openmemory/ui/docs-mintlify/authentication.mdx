...
For detailed instructions on implementing this flow, please consult standard OAuth 2.1 documentation and contact our support team for your `client_id` and `client_secret`.
