...
<Card title="Skip the reading, start building" icon="lightning-bolt">
      ...
      fetch('/assets/consolidated-docs.md')
        ...
        .then(text => {
          navigator.clipboard.writeText(text).then(() => {
            document.getElementById('copyDocsBtn').textContent = '✅ Copied!';
            setTimeout(() => {
              document.getElementById('copyDocsBtn').textContent = '📋 Copy All Docs for AI';
            }, 2000);
          });
        })
        .catch(err => {
          console.error('Failed to copy: ', err);
          document.getElementById('copyDocsBtn').textContent = '❌ Failed';
          setTimeout(() => {
            document.getElementById('copyDocsBtn').textContent = '📋 Copy All Docs for AI';
          }, 2000);
        });
