...
def main():
    ...
    consolidated_content.append("```python")
    consolidated_content.append("from jeanmemory import JeanClient")
    consolidated_content.append("jean = JeanClient(api_key=\"your-api-key\")")
    ...
    consolidated_content.append("import { JeanClient } from '@jeanmemory/node';")
    consolidated_content.append("const jean = new JeanClient({ apiKey: \"your-api-key\" });")
