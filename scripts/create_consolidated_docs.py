...
def main():
    ...
    # Output the TS module inside the docs directory so the dev server can see it.
    ...
    # Escape backticks and template literal syntax in the content to avoid breaking the template literal
