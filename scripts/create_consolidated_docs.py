...
def main():
    ...
    consolidated_content.append("")
    consolidated_content.append("#### React (2 lines):")
    consolidated_content.append("```tsx")
    consolidated_content.append("import { JeanProvider, JeanChatComplete } from '@jeanmemory/react';")
    consolidated_content.append("")
    consolidated_content.append("function MyApp() {")
    consolidated_content.append("  return (")
    consolidated_content.append("    <JeanProvider apiKey=\"your-api-key\">")
    consolidated_content.append("      <JeanChatComplete />")
    consolidated_content.append("    </JeanProvider>")
    consolidated_content.append("  );")
    consolidated_content.append("}")
    consolidated_content.append("```")
    consolidated_content.append("")
    ...
    consolidated_content.append("```python")
    consolidated_content.append("from jeanmemory import JeanMemoryClient")
    consolidated_content.append("jean = JeanMemoryClient(api_key=\"your-api-key\")")
    consolidated_content.append("context = jean.get_context(user_token=\"token\", message=\"Hello\")")
    consolidated_content.append("```")
    consolidated_content.append("")
    consolidated_content.append("#### Node.js:")
    consolidated_content.append("```javascript")
    consolidated_content.append("import { JeanMemoryClient } from '@jeanmemory/node';")
    consolidated_content.append("const jean = new JeanMemoryClient({ apiKey: \"your-api-key\" });")
    consolidated_content.append("const context = await jean.getContext({ user_token: \"token\", message: \"Hello\" });")
    consolidated_content.append("```")
    consolidated_content.append("")
