...
async def test_unified_search():
    ...
    try:
        ...
        test_queries = [
            {
                "query": "fitness and gym activities",
                "description": "Should find fitness-related memories"
            },
            {
                "query": "July 4th fireworks San Francisco",
                "description": "Should find the specific fireworks memory"
            },
            {
                "query": "protein smoothie experiment",
                "description": "Should find the smoothie memory"
            },
            {
                "query": "YC interview and feedback",
                "description": "Should find YC-related memories"
            },
            {
                "query": "coding and all nighter",
                "description": "Should find coding-related memories"
            },
            {
                "query": "San Francisco lifestyle",
                "description": "Should find SF-related memories"
            },
            {
                "query": "recent activities from June 2025",
